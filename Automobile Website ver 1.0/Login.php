    ...
    <div class="form-section">
      ...
      <div id="signupFormContainer" class="hidden">
        <form method="POST" action="" onsubmit="return validateSignup()">
            ...
            <span id="signupUsernameError" class="error">Username must be at least 3 characters long.</span>
            ...
            <span id="signupPasswordError" class="error">Password must be at least 6 characters long.</span>
